package enstabretagne.BE.AnalyseSousMarine.SimEntity.Ocean.Representation3D;
...
public class EntityOcean3DRepresentation extends Representation3D {
	...
	public void init(Group world, Object obj) {
		...
		double longueur = 20000; 
		double largeur = 20000; //20Km*20km 
		double epaisseurs = 3000;  //3km epaisseur
		Group g = new Group();

		double alpha0 = 0.1;
		double max = longueur / epaisseurs;
		int i = 0;
		for (i = 0; i < max; i++) {
			Box b = new Box(longueur, largeur, epaisseurs);
